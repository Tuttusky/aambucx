...
var menuItems = document.querySelectorAll(".bls__menu-parent"),
    menuDropdown1 = document.querySelectorAll(".dropdown li.level-1"),
    menuDropdown2 = document.querySelectorAll(".dropdown li.level-2");
...
class FeatureButton extends HTMLElement {
    ...
    htmlRender() {
        ...
        for (let e in n) {
            ...
            i.setAttribute("target", "_blank"), "v1" == n[e][5] ? i.setAttribute("href", "https://umino-demo.myshopify.com/?preview_theme_id=" + n[e][1]) : "v2" == n[e][5] && i.setAttribute("href", "https://umino-demo-v2.myshopify.com/?preview_theme_id=" + n[e][1]), i.setAttribute("title", n[e][2]);
            const s = document.createElement("img");
            if (s.setAttribute("width", "350"), s.setAttribute("height", "256"), s.setAttribute("loading", "lazy"), s.setAttribute("src", "https://blueskytechmage.com/shopify/umino-preview-home/" + n[e][0]), s.setAttribute("alt", n[e][2]), i.appendChild(s), "" != n[e][3]) {
            ...
            a.setAttribute("target", "_blank"), "v1" == n[e][5] ? a.setAttribute("href", "https://umino-demo.myshopify.com/?preview_theme_id=" + n[e][1]) : "v2" == n[e][5] && a.setAttribute("href", "https://umino-demo-v2.myshopify.com/?preview_theme_id=" + n[e][1]), a.setAttribute("title", n[e][2]), a.appendChild(document.createTextNode(n[e][2])), r.appendChild(a), l.appendChild(r);
...
var BlsEventShopify = {
    ...
    setupEventListeners: function() {
        ...
        i && (getCookie("term_conditions") ? (i.setAttribute("checked", ""), s && s.classList.remove("disabled")) : i.addEventListener("change", (e => {
        ...
        if (null !== t && e) {
            ...
            if (t > 1199)
                if (i > o) {
                    ...
                    })), document.querySelector(".menu-slide .expand-menu-link").style.display = "block", document.querySelector(".menu-slide .expand-menu-link a").addEventListener("click", (e => {
                        e.preventDefault();
...
var BlsInstagramShopify = {
    ...
    initInstagram: async function(e, t, n, o) {
        const i = this;
        let s = void 0 !== n ? n : 4;
        const l = await this.fetchCache(`https://graph.instagram.com/me/media?fields=caption,id,media_type,media_url,permalink,thumbnail_url,timestamp,username&access_token=${t}`, {
            cache: "force-cache"
        });
...
var BlsColorSwatchesShopify = {
    ...
    renderProductInfo(e, t, n, o) {
        ...
        if (p && p.remove(), h) {
            ...
            if (l) {
                let t;
                h.style.display = "flex", t = "price" == window.productLabel.saleType ? e.replace("[percent_sale]", "- " + Shopify.formatMoney(u - m, cartStrings.money_format)) : "percent" == window.productLabel.saleType ? e.replace("[percent_sale]", s.toFixed(0) + "%") : e.replace("[percent_sale]", ""), h.querySelectorAll(".sale-content-product").forEach((e => {
                    e.innerText = t
                }))
        ...
        if (l || a || r) {
            ...
            if (l)
                if (e.querySelector(".bls__sale-label")) "price" == window.productLabel.saleType ? e.querySelector(".bls__sale-label").innerText = "- " + Shopify.formatMoney(u - m, cartStrings.money_format) : "text" == window.productLabel.saleType ? e.querySelector(".bls__sale-label").innerText = window.productLabel.saleLabel : e.querySelector(".bls__sale-label").innerText = -s.toFixed(0) + "%";
                    ...
                    f.classList.add("bls__sale-label"), "price" == window.productLabel.saleType ? f.innerText = "- " + Shopify.formatMoney(u - m, cartStrings.money_format) : "text" == window.productLabel.saleType ? f.innerText = window.productLabel.saleLabel : f.innerText = -s.toFixed(0) + "%", e && e.appendChild(f)
                } if (r)
...
var BlsSearchShopify = {
    ...
    getSearchResults: function(e) {
        ...
        if (this.setLiveRegionLoadingState(), t[n]) this.renderSearchResults(t[n]);
            ...
            if (document.querySelector(".predictive_search_suggest")) var i = `${routes?.predictive_search_url}?q=${encodeURIComponent(e)}&resources[options][fields]=title,tag,vendor,product_type,variants.title,variants.sku&resources[options][prefix]=last&resources[options][unavailable_products]=last&resources[type]=query,product,collection&resources[limit]=6&section_id=${o}`;
...
class AgeVerifier extends HTMLElement {
    constructor() {
        super(), this.ageVerifyDetail = this.querySelector(".age-verify-detail"), this.declineVerifyDetail = this.querySelector(".decline-verify-detail"), this.init(), this.mainFunction(), Shopify.designMode && (document.addEventListener("shopify:section:load", (() => this.init())), document.addEventListener("shopify:section:load", (() => this.mainFunction())))
    }
    init() {
        const e = this,
            t = e.dataset.enableDesignMode;
        Shopify.designMode ? "true" == t ? document.addEventListener("shopify:section:select", (t => {
